...
// are applied afterwards in `GraphicContext.toScreen`, so they're NOT
...
extension AppState {
    ...
    func visibleStars(forScale scale: Double) -> ArraySlice<Star> {
