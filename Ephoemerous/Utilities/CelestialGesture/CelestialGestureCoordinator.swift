...
final class CelestialGestureCoordinator {
    ...
    let minimumScale:           Double = 90     // hard zoom-out floor for all gestures — independent of launch scale
    ...
    let scaleRubberStiffness:   Double = 2      // zoom past floor/ceiling: higher = stiffer spring, no hard wall. See rubberScale
