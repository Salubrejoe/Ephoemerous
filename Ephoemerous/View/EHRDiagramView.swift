...
// `EStarKnownData`, computes absolute magnitudes, and scatters them by
...
struct EHRDiagramView: View {
    ...
    private static let classOrder: [EHRClass] = [.O, .B, .A, .F, .G, .K, .M]
    ...
    private static func makePoints() -> [HRPoint] {
        ...
        pts.append(HRPoint(id:     "sun",
                           name:   ESkyObject.sun.displayName,
                           xClass: 4.0,
                           absMag: 4.83,
                           cls:    .G,
                           isSun:  true))
