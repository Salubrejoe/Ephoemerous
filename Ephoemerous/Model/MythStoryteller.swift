...
final class MythStoryteller {
    ...
    enum Tone: String, CaseIterable, Identifiable {
        ...
        fileprivate var instruction: String {
            ...
            case .poetic:
                "Lyrical and image-rich, a touch reverent, but clear and easy to follow."
            case .kid:
                "Simple, playful and full of wonder, for a curious child. Short sentences, nothing frightening."
            }
        }
    }
    ...
    private static func persona(tone: Tone) -> String {
        ...
        Tell the origin of a constellation in about 3 or 4 sentences, ending on how it
    ...
    private static func starFacts(for cons: EConstellation) -> String? {
        ...
        var s = "You may weave in AT MOST ONE real fact, lightly: its brightest star is "
