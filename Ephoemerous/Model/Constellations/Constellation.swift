...
//    }
  ...
  func visibleStars(cutoff magnitude: Double) -> [Star] {
...
extension Constellation {
  ...
  static var zodiacIndexedStars: [Star] {
    var result = [Star]()
    for constellation in Constellation.allCases {
  ...
  static func visibleZodiacStars(cutoff magnitude: Double = 10) -> [Star] {
    var result = [Star]()
    for constellation in Constellation.allCases {
      if constellation.isZodiacSign {
  ...
  static func visibleStars(cutoff magnitude: Double = 10) -> [Star] {
    var result = [Star]()
    for constellation in Constellation.allCases {
