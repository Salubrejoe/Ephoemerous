...
final class WeatherProvider {
    ...
    // TODO: Audit - sunEvents is fetched for detail views (SunDetailView, MoonDetailView); the sky background now uses sun altitude instead. Consider whether WeatherKit fetch is still needed or can be scoped further
    private(set) var sunEvents:  SunEvents?  = nil
    private(set) var moonEvents: MoonEvents? = nil
